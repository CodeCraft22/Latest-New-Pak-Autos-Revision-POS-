...
namespace Csharp_Project
{
    class User
    {
        ...
        public void insertUser(string username, string fullname, string password, string tel, string email, string Role)
        {
            ...
            parameters[5] = new SqlParameter("@Role", SqlDbType.VarChar, 255);
        ...
        public void updateUser(string username, string fullname, string password, string tel, string email, int uid,string Role)
        {
            ...
            parameters[6] = new SqlParameter("@Role", SqlDbType.VarChar, 255);
            parameters[6].Value = Role;
