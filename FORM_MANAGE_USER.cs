...
namespace Csharp_Project
{
    public partial class FORM_MANAGE_USER : Form
    {
        ...
        private void DGV_USERS_Click(object sender, EventArgs e)
        {
            ...
            string cmb = DGV_USERS.CurrentRow.Cells[6].Value.ToString();
            cmbRole1.SelectedValue = cmb;
        ...
        private void BTN_UPDATE_Click(object sender, EventArgs e)
        {
            if (TB_ID.Text != string.Empty)
            {
                user.updateUser(TB_USERNAME.Text, TB_FULLNAME.Text, TB_PASSWORD.Text, TB_TEL.Text, TB_EMAIL.Text, Convert.ToInt32(TB_ID.Text),cmbRole1.SelectedItem.ToString());
